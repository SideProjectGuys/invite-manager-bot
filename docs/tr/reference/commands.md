...
| Command                               | Description                                                                                                                                   | Usage                                                            |
| ------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------- |
| [ban](#ban)                           | Sunucudan üye yasaklama.                                                                                                                      | !ban [-d value\|--deleteMessageDays=value] \<user\> [reason]     |
...
| Argument | Type          | Required | Description                 | Details |
| -------- | ------------- | -------- | --------------------------- | ------- |
| user     | [User](#User) | Yes      | Yasaklamak için kullanıcı.  |         |
...
| --------------------------------- | --------- | ------------- | ------------------------------------ |
| &#x2011;&#x2011;deleteMessageDays | &#x2011;d | [Sayı](#Sayı) | cmd.ban.self.flags.deleteMessageDays |
...
| Argument | Type          | Required | Description                | Details |
| -------- | ------------- | -------- | -------------------------- | ------- |
| member   | [Üye](#Üye)   | Yes      | Member to kick.            |         |
