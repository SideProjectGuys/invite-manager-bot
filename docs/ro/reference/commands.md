...
| Command                                 | Description                                        | Usage                                                            |
| --------------------------------------- | -------------------------------------------------- | ---------------------------------------------------------------- |
| [addInvites](#addInvites)               | Adaugă/Șterge invitațiile pentru un membru.        | !addInvites \<user\> \<amount\> [reason]                         |
...
| Command                   | Description                                   | Usage                                |
| ------------------------- | --------------------------------------------- | ------------------------------------ |
| [addRank](#addRank)       | Adaugă un rank nou.                           | !addRank \<role\> \<invites\> [info] |
...
Adaugă/Șterge invitațiile pentru un membru.
...
| -------- | ----------------- | -------- | -------------------------------------------------------------------------------------------------------------- | ------- |
| user     | [User](#User)     | Yes      | Membrul care va primii/pierde invitațiile bonus.                                                               |         |
| amount   | [Number](#Number) | Yes      | Numărul de invitații user-ul o sa primească/piardă. Folosește un număr negativ (-) pentru a șterge invite-uri. |         |
| reason   | [Text](#Text)     | No       | Motivul pentru adăugarea/ștergerea invitațiilor.                                                               |         |
...
| Argument | Type              | Required | Description                                                                        | Details |
| -------- | ----------------- | -------- | ---------------------------------------------------------------------------------- | ------- |
| role     | [Role](#Role)     | Yes      | Rolul pe care membrul îl va primii când atinge acest rank.                         |         |
| invites  | [Number](#Number) | Yes      | Numărul de invitații necesar pentru a primii rank-ul.                              |         |
| info     | [Text](#Text)     | No       | O descriere pe care membrii o vor vedea pentru a afla mai multe despre acest rank. |         |
...
Interzice un membru de pe acest server.
...
| Argument | Type          | Required | Description                         | Details |
| -------- | ------------- | -------- | ----------------------------------- | ------- |
| user     | [User](#User) | Yes      | Membrul pentru interzicere.         |         |
| reason   | [Text](#Text) | No       | De ce a fost acest membru interzis. |         |
