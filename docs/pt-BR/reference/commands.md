...
| ------------------------------------- | --------------------------------------------------------- | --------------------------------------------- |
| [botConfig](#botConfig)               | Mostrar e alterar as configurações do bot.                | !botConfig [key][value]                       |
...
| Command             | Description                                                                       | Usage           |
| ------------------- | --------------------------------------------------------------------------------- | --------------- |
| [botInfo](#botInfo) | Dá informações gerais sobre o bot.                                                | !botInfo        |
...
| Command                                 | Description                                        | Usage                                                            |
| --------------------------------------- | -------------------------------------------------- | ---------------------------------------------------------------- |
| [addInvites](#addInvites)               | Adiciona/Remove convites para/de um membro.        | !addInvites \<user\> \<amount\> [reason]                         |
...
| Command                               | Description                                                                                                                                   | Usage                                                            |
| ------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------- |
| [ban](#ban)                           | Bane um membro do servidor.                                                                                                                   | !ban [-d value\|--deleteMessageDays=value] \<user\> [reason]     |
| [caseDelete](#caseDelete)             | Elimine um case específico.                                                                                                                   | !caseDelete \<caseNumber\> [reason]                              |
| [caseView](#caseView)                 | Veja a informação de um determinado case.                                                                                                     | !caseView \<caseNumber\>                                         |
| [check](#check)                       | Checa o histórico de violações e punimentos de um usuário.                                                                                    | !check \<user\>                                                  |
| [clean](#clean)                       | Limpar um canal de certo tipo de mensagens.                                                                                                   | !clean \<type\> [numberOfMessages]                               |
...
| Command                   | Description                                   | Usage                                |
| ------------------------- | --------------------------------------------- | ------------------------------------ |
| [addRank](#addRank)       | Adiciona um novo rank.                        | !addRank \<role\> \<invites\> [info] |
...
Adiciona/Remove convites para/de um membro.
...
| -------- | ----------------- | -------- | -------------------------------------------------------------------------------------------------------- | ------- |
| user     | [User](#User)     | Yes      | O usuário que vai receber/perder os convites bônus.                                                      |         |
| amount   | [Number](#Number) | Yes      | A quantia de convites que o usuário irá ganhar/perder. Use um número negativo (-) para remover convites. |         |
| reason   | [Text](#Text)     | No       | A razão para adicionar/remover os convites                                                               |         |
...
| Argument | Type              | Required | Description                                                               | Details |
| -------- | ----------------- | -------- | ------------------------------------------------------------------------- | ------- |
| role     | [Role](#Role)     | Yes      | O cargo que o usuário irá receber quando conquistar esse rank.            |         |
| invites  | [Number](#Number) | Yes      | A quantia de convites necessárias para chegar neste rank.                 |         |
| info     | [Text](#Text)     | No       | Uma descrição que os usuários irão ver para saberem mais sobre esse rank. |         |
...
| Argument | Type          | Required | Description                   | Details |
| -------- | ------------- | -------- | ----------------------------- | ------- |
| user     | [User](#User) | Yes      | Usuário para banir.           |         |
| reason   | [Text](#Text) | No       | Por que o usuário foi banido. |         |
...
Mostrar e alterar as configurações do bot.
...
| Argument | Type            | Required | Description                                                      | Details                                                                                                                                     |
| -------- | --------------- | -------- | ---------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
| key      | [Enum](#Enum)   | No       | A config da configuração do bot que você deseja mostrar/alterar. | Use one of the following values: `activityEnabled`, `activityMessage`, `activityStatus`, `activityType`, `activityUrl`, `embedDefaultColor` |
| value    | [Value](#Value) | No       | O novo valor da configuração.                                    |                                                                                                                                             |
...
Dá informações gerais sobre o bot.
...
| Argument   | Type              | Required | Description                  | Details |
| ---------- | ----------------- | -------- | ---------------------------- | ------- |
| caseNumber | [Number](#Number) | Yes      | Número da case.              |         |
| reason     | [Text](#Text)     | No       | A razão para remover o case. |         |
...
Veja a informação de um determinado case.
...
Checa o histórico de violações e punimentos de um usuário.
...
| Argument | Type          | Required | Description          | Details |
| -------- | ------------- | -------- | -------------------- | ------- |
| user     | [User](#User) | Yes      | Usuário para checar. |         |
...
Limpar um canal de certo tipo de mensagens.
...
| Argument         | Type              | Required | Description                                | Details                                                                                                            |
| ---------------- | ----------------- | -------- | ------------------------------------------ | ------------------------------------------------------------------------------------------------------------------ |
| type             | [Enum](#Enum)     | Yes      | O tipo de mensagens que serão excluídas.   | Use one of the following values: `bots`, `embeds`, `emojis`, `images`, `links`, `mentions`, `reacted`, `reactions` |
| numberOfMessages | [Number](#Number) | No       | Número de mensagens que serão pesquisadas. |                                                                                                                    |
...
| Argument   | Type                       | Required | Description                                                | Details                                                                 |
| ---------- | -------------------------- | -------- | ---------------------------------------------------------- | ----------------------------------------------------------------------- |
| key        | [Enum](#Enum)              | Yes      | The config setting which you want to show/change.          | Use one of the following values: `hideFromLeaderboard`, `name`, `roles` |
...
| Argument | Type            | Required | Description                                              | Details                          |
| -------- | --------------- | -------- | -------------------------------------------------------- | -------------------------------- |
| key      | [Enum](#Enum)   | Yes      | The member config setting which you want to show/change. | Use one of the following values: |
...
| Argument | Type          | Required | Description                     | Details |
| -------- | ------------- | -------- | ------------------------------- | ------- |
| message  | [Text](#Text) | No       | The message of the placeholder. |         |

### Flags

| Flag                 | Short     | Type          | Description                                |
| -------------------- | --------- | ------------- | ------------------------------------------ |
| &#x2011;&#x2011;edit | &#x2011;e | [Text](#Text) | The message id of the placeholder to edit. |
...
| Argument  | Type          | Required | Description                          | Details |
| --------- | ------------- | -------- | ------------------------------------ | ------- |
| messageId | [Text](#Text) | Yes      | cmd.reactionRole.self.args.messageId |         |
| emoji     | [Text](#Text) | Yes      | cmd.reactionRole.self.args.emoji     |         |
| role      | [Role](#Role) | No       | cmd.reactionRole.self.args.role      |         |
...
| reason   | [Text](#Text)     | No       | cmd.strike.self.args.reason       |                                                                                                                                                              |
