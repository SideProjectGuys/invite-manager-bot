...
| Setting                                   | Description                                             |
| ----------------------------------------- | ------------------------------------------------------- |
| [Embed Default Color](#embeddefaultcolor) | The default color of bot messages.                      |
| [Enabled](#activityenabled)               | If enabled the bot will use the custom activity status. |
| [Message](#activitymessage)               | The activity message of the bot.                        |
| [Status](#activitystatus)                 | The activity status of the bot.                         |
| [Type](#activitytype)                     | The activity type of the bot.                           |
| [URL](#activityurl)                       | The twitch.tv activity link of the bot.                 |
...
| Setting                                       | Description                                                                      |
| --------------------------------------------- | -------------------------------------------------------------------------------- |
| [Hide from Leaderboard](#hidefromleaderboard) | If enabled the member is hidden from the leaderboard.                            |
| [Name](#name)                                 | The name of the invite code                                                      |
| [Roles](#roles)                               | The roles that are assigned to people using this invite code to join the server. |
...
## Custom Bot - Embed Default Color

The default color of bot messages.
...
If enabled the bot will use the custom activity status.
...
The activity message of the bot.
...
The activity status of the bot.
...
The twitch.tv activity link of the bot.
...
## Invites - Hide from Leaderboard

If enabled the member is hidden from the leaderboard.
...
The roles that are assigned to people using this invite code to join the server.
