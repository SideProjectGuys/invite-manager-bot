...
export type MemberSettingsTypesObject = { [k in MemberSettingsKey]: InternalSettingsTypes };
...
export type InviteCodeSettingsTypesObject = { [k in InviteCodeSettingsKey]: InternalSettingsTypes };
